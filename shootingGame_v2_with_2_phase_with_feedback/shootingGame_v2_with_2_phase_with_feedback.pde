...
class Monster {
  ...
  // try to make another monster with different move set
  //void showMonster2(){
  // // collision in x direction
  // if(mX + mW > player.pX &&
  //    mX < player.pX + player.pW &&
  ...
  //  mX += 0;
  //  mY += mSpdY + 5; // but i want to try the speed gradualy become faster. maybe use for loop and delay?
  //  pushStyle();
  //  fill(random(255),random(255),random(255));
  //  rect(mX,mY,mW,mH);
  //  popStyle();
